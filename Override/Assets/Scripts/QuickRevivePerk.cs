...
public class QuickRevivePerk : MonoBehaviour
{
    ...
    {
        if (other.CompareTag("Player") && !player.hasQuickRevive)
        {
            isInTrigger = true;
        }
    }
    ...
    void Update()
    {
        if (isInTrigger == true)
        {
            ...
            promptText.text = "Press F to buy Extra Life for " + perkCost + " points";
